...
// ضع الآيدي الخاص بك وصاحب السيرفر وروم التنبيهات هنا (اختياري، يمكنك تركها أرقام تجريبية مؤقتاً)
const SERVER_OWNER_ID = "123456789012345678"; 
const NOTIFICATION_CHANNEL_ID = "123456789012345678"; 
